...
<div class="bl_c">
	<div class="home_cours_top">
		<div class="bl_cours_head">
			<h5 class="bl_ch_h">Топ курстар</h5>
		...
		<div class="swiper-container slide_max">
	    	<div class="swiper-wrapper">
		    	<?php
			      while($ana = mysqli_fetch_array($sql)) {
		    			...
		    			echo '
					      	<div class="swiper-slide slm_item">
	    	...
	    	<div class="swiper-pagination slide_max_pag"></div>
		    <div class="swiper-button-next slide_max_next">
		    	<i class="fal fa-long-arrow-right"></i>
		    </div>
		    <div class="swiper-button-prev slide_max_prev">
